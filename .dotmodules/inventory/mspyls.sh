...
echo    git clone --depth=1 https://github.com/microsoft/python-language-server.git ~/.local/src/python-language-server
echo    cd ~/.local/src/python-language-server/src/LanguageServer/Impl
echo    dotnet build
