...
# This didn't really work in ampere01 last time -- it kept dying with Server exited unexpectedly, and according to strace, libnss_files-2.28.so was getting a segfault.
